...
def resize_image(image):
    """
    Resize the input image to the required size: CONFIG.IMAGE_WIDTH, CONFIG.IMAGE_HEIGHT
    """
...
def generate_noise_image(content_image, noise_ratio = CONFIG.NOISE_RATIO):
    ...
    noise_image = np.random.uniform(-20, 20, 
        (1, CONFIG.IMAGE_HEIGHT, CONFIG.IMAGE_WIDTH, CONFIG.COLOR_CHANNELS)).astype('float32')
